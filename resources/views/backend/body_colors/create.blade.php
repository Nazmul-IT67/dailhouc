        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="card p-4">
                        <h4 class="mb-4">Add New Body Color</h4>

                        <form action="{{ route('admin.body_colors.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label for="name_fr" class="form-label">Color Name (Fr)<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="color" name="color_code" id="color_code"
                                    ...
                                    value="{{ old('color_code') }}" placeholder="#FFFFFF">
                                @error('color_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">Save Body Color</button>
                            </div>
                        </form>
                    </div>
                </div>
