    ...
    <div class="page-body">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            <i class="fa fa-plus fa-2x me-3"></i>
                            <h2 class="mb-0 text-white">Add Axle Count</h2>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="p-4 card">
                        <form action="{{ route('admin.axle-counts.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-success">Add Axle Count</button>
                        </form>
                    </div>
                </div>
            </div>
