    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="p-3 rounded d-flex align-items-center justify-content-between"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="mb-0 text-white">Add Cylinder</h2>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="card p-4">
                    <form action="{{ route('admin.cylinders.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="number" class="form-label">Cylinder Number</label>
                            <input type="number" class="form-control" id="number" name="number"
                                   value="{{ old('number') }}" placeholder="Enter cylinder number" required>
                            @error('number')
