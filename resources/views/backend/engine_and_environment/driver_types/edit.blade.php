...
@section('title', 'Edit Driver Type')
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Edit Driver Type</h2>
                        </div>
                        <a href="{{ route('admin.driver_types.index') }}" class="btn btn-lg"
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="card p-4">
                        <form action="{{ route('admin.driver_types.update', $driverType->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="title" class="form-label">Driver Type Title (En)</label>
                                <input type="text" class="form-control" id="title" name="title"
                                    value="{{ old('title', $driverType->title) }}" placeholder="Enter driver type title"
                                    required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title_fr" id="title_fr"
                                    ...
                                    value="{{ old('title_fr', $driverType->translations->where('language', 'fr')->first()->title ?? '') }}" 
