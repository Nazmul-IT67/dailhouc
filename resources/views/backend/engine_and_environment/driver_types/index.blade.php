    ...
    <div class="page-body">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Driver Types</h2>
                        </div>
                        <a href="{{ route('admin.driver_types.create') }}" class="btn btn-lg"
                            style="background-color: white; color: #006666; font-weight: 600; border: 1px solid #ccc;">
                            <i class="fa fa-plus"></i> Add Driver Type
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-4 card">
                        <table id="driver-type-table" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title (En)</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            $('#driver-type-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.driver_types.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        function deleteItem(id) {
            let url = '{{ route('admin.driver_types.destroy', ':id') }}';
            ...
            $.ajax({
                ...
                success: function(resp) {
                    $('#driver-type-table').DataTable().ajax.reload();
