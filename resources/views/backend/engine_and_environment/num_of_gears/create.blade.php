...
@section('title', 'Add Number of Gear')
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Add Number of Gear</h2>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="card p-4">
                        <form action="{{ route('admin.num_of_gears.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="number" class="form-label">Number of Gear</label>
                                <input type="text" class="form-control" id="number" name="number"
                                    value="{{ old('number') }}" placeholder="Enter number of gear" required>
                                @error('number')
