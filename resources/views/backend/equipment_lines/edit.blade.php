...
@section('title', 'Edit Equipment Line')
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Edit Equipment Line</h2>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="card p-4">
                        <form action="{{ route('admin.equipment_lines.update', $equipmentLine->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="title" class="form-label">Title (En)</label>
                                <input type="text" class="form-control" id="title" name="title"
                                    value="{{ old('title', $equipmentLine->title) }}"
                                    placeholder="Enter equipment line title" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title_fr" id="title_fr"
                                    ...
                                    value="{{ old('title_fr', $equipmentLine->translations->where('language', 'fr')->first()->title ?? '') }}" 
