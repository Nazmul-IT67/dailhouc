...
@section('title', 'Edit Interior Color')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="card p-4">
                        <h4 class="mb-4">Edit Interior Color</h4>

                        <form action="{{ route('admin.interior_colors.update', $interiorColor->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_fr" id="name_fr"
                                    ...
                                    value="{{ old('name_fr', $interiorColor->translations->where('language', 'fr')->first()->name ?? '') }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="color" name="color_code" id="color_code"
                                    ...
                                    value="{{ old('color_code', $interiorColor->color_code ?? '#000000') }}">
                                @error('color_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
