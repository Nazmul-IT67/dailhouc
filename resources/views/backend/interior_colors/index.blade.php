                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Interior Colors</h2>
                        </div>
                        <a href="{{ route('admin.interior_colors.create') }}" class="btn  btn-lg"
                            ...
                            <i class="fa fa-plus"></i> Add Interior Color
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-4 card">
                        ...
                        <table id="interior-color-table" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name (En)</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            $('#interior-color-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.interior_colors.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        function deleteItem(id) {
            let url = '{{ route('admin.interior_colors.destroy', ':id') }}';
            ...
            $.ajax({
                ...
                success: function(resp) {
                    $('#interior-color-table').DataTable().ajax.reload();
