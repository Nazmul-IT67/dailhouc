                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Model Year</h2>
                        </div>
                        <a href="{{ route('admin.model_years.create') }}" class="btn btn-lg"
    ...
    <script>
        $(document).ready(function() {
            $('#number-of-seats-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.model_years.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        function deleteItem(id) {
            let url = '{{ route('admin.model_years.destroy', ':id') }}';
