    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"> <a href="index.html"><img class="img-fluid for-light"
                        src="{{ asset('backend/images/logo.png') }}" alt="logo-light"><img class="img-fluid for-dark"
                        src="{{ asset('backend/images/logo.png') }}" alt="logo-dark"></a>
            </div>
            ...
            <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                <div class="d-flex align-items-center gap-2 ">
                    <h4 class="f-w-600">Welcome Alex</h4><img class="mt-0"
                        src="{{ asset('backend/images/hand.gif') }}" alt="hand-gif">
                </div>
            </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="media profile-media">
                        <img width="50px" class="b-r-10" src="{{ asset(auth()->user()->avatar) }}" alt="">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route('admin.profile.setting') }}"><i data-feather="user"></i><span>My
                                    Profile</span></a>
                        </li>
                        <li> <a href="{{ route('admin.system.index') }}"> <i
        ...
        <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">Jhon</div>
            </div>
            </div>
          </script>
