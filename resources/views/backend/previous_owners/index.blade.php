    ...
    <div class="page-body">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="p-3 rounded d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <h2 class="mb-0 text-white">Previous Owners</h2>
                        </div>
                        <a href="{{ route('admin.previous_owners.create') }}" class="btn btn-lg"
                            style="background-color: white; color: #006666; font-weight: 600; border: 1px solid #ccc;">
                            <i class="fa fa-plus"></i> Add Previous Owner
                        </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-4 card">
                        <table id="previous-owner-table" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>#</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            $('#previous-owner-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.previous_owners.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        function deleteItem(id) {
            let url = '{{ route('admin.previous_owners.destroy', ':id') }}';
            ...
            $.ajax({
                ...
                success: function(resp) {
                    $('#previous-owner-table').DataTable().ajax.reload();
